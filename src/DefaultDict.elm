...
isBBlack dict =
    case dict of
      ...
      RBEmpty_elm_builtin LBBlack v -> True
      _ -> False
...
rem c l r =
    case (l, r) of
      (RBEmpty_elm_builtin _ v, RBEmpty_elm_builtin _ _) ->
          case c of
            Red   -> RBEmpty_elm_builtin LBlack v
            Black -> RBEmpty_elm_builtin LBBlack v
            _ ->
...
blacken t =
    case t of
      RBEmpty_elm_builtin _ v -> RBEmpty_elm_builtin LBlack v
...
redden t =
    case t of
      RBEmpty_elm_builtin _ v -> Debug.crash "can't make a Leaf red"
